...
$string['list'] = 'List';
$string['myoverview_term_filter:addinstance'] = 'Add a new course overview block';
$string['myoverview_term_filter:myaddinstance'] = 'Add a new course overview block to Dashboard';
$string['nocourses'] = 'No courses';
$string['past'] = 'Past';
$string['pluginname'] = 'Course overview (semester)';
