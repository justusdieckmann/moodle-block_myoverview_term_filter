...
function(
    ...
    var TEMPLATES = {
        COURSES_CARDS: 'block_myoverview_term_filter/view-cards',
        COURSES_LIST: 'block_myoverview_term_filter/view-list',
        COURSES_SUMMARY: 'block_myoverview_term_filter/view-summary',
        NOCOURSES: 'block_myoverview_term_filter/no-courses'
    };
    ...
    var DEFAULT_PAGED_CONTENT_CONFIG = {
        ...
        persistentLimitKey: 'block_myoverview_term_filter_user_paging_preference'
    };
    ...
    var initializePagedContent = function(root) {
        namespace = "block_myoverview_term_filter_" + root.attr('id') + "_" + Math.random();
    ...
    /**
     * Listen to, and handle events for  the myoverview_term_filter block.
     *
     * @param {Object} root The myoverview_term_filter block container element.
     */
